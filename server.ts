...
async function startServer() {
  ...
  partnerRoutes(v1);
  proPeriodRoutes(v1);
  loyaltyDiscountRoutes(v1);
  insightRoutes(v1);
  referralRoutes(v1);
  phoneRelayRoutes(v1);
  banActionRoutes(v1);
  reviewModerationRoutes(v1);
  backupSitterRoutes(v1);
