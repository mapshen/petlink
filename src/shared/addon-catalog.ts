...
export const ADDON_CATALOG: readonly AddonDefinition[] = [
  // Care
  {
    ...
    applicableServices: ['walking', 'sitting', 'boarding', 'drop-in', 'daycare', 'grooming'],
    species: 'all',
    canOfferFree: false,
  ...
  },
  {
    ...
    category: 'care',
    pricingUnit: 'per night',
    applicableServices: ['walking', 'sitting', 'boarding', 'drop-in', 'daycare'],
    species: 'all',
    canOfferFree: false,
    defaultPriceCents: 1000,
  },
  // Grooming
  {
    ...
    applicableServices: ['sitting', 'boarding', 'daycare', 'drop-in'],
    species: ['dog', 'cat'],
    canOfferFree: true,
  ...
  },
  {
    ...
    category: 'grooming',
    pricingUnit: 'per session',
    applicableServices: ['sitting', 'boarding', 'daycare'],
    species: ['dog', 'cat', 'small_animal'],
    canOfferFree: false,
  ...
  // Convenience
  {
    ...
    applicableServices: ['sitting', 'boarding', 'daycare', 'walking'],
    species: 'all',
    canOfferFree: false,
    defaultPriceCents: 1500,
  },
  ...
  },
  {
    ...
    category: 'convenience',
    pricingUnit: 'per night',
    applicableServices: ['sitting', 'boarding'],
    species: 'all',
    canOfferFree: true,
    defaultPriceCents: 0,
  },
