              ...
              <div className="bg-white rounded-2xl border border-stone-200 p-6">
                ...
                {user && !user.emergency_contact_name && (
                  <div className="mb-6 p-3 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-700">
                    <Link to="/profile#section-contact-privacy" className="font-semibold underline hover:text-amber-800">Add an emergency contact</Link> in Settings — sitters need someone to reach in case of a pet emergency.
                  </div>
                )}
