    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-10 text-stone-700 leading-relaxed">
        <section>
          ...
          <p>
            PaloPlot, LLC ("we", "us", "PetLink") operates the PetLink platform at petlink.app. This
            Privacy Policy describes how we collect, use, and protect your personal information when
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1.5">
            <li><span className="font-medium">Account information</span> — name, email address, and password hash</li>
            ...
            <li><span className="font-medium">Location data</span> — address and geographic coordinates for sitter search and service matching</li>
            <li><span className="font-medium">Booking history</span> — service requests, dates, and status</li>
            <li><span className="font-medium">Payment information</span> — processed and stored securely by Stripe; we do not store card numbers</li>
            <li><span className="font-medium">Profile photos</span> — uploaded images and sitter portfolio photos</li>
            <li><span className="font-medium">Messages</span> — communications between owners and sitters on the platform</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1.5">
            ...
            <li>Process payments and facilitate transactions between owners and sitters</li>
            <li>Send notifications about bookings, messages, and account activity</li>
            <li>Improve the platform, analyze usage patterns, and develop new features</li>
        ...
        <section>
          ...
          <p className="mb-3">
            We share information only with the following third-party service providers as necessary
            to operate PetLink:
          </p>
          <ul className="list-disc pl-6 space-y-1.5">
            <li><span className="font-medium">Stripe</span> — payment processing</li>
            <li><span className="font-medium">Resend</span> — transactional email delivery</li>
            <li><span className="font-medium">Checkr</span> — sitter background checks</li>
            <li><span className="font-medium">AWS S3</span> — file and photo storage</li>
          </ul>
        ...
        <section>
          ...
          <p>
            ...
            deletion, your data will be permanently removed within 30 days of the request. Aggregated,
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1.5">
            ...
            <li><span className="font-medium">Export</span> — receive your data in a portable format</li>
            <li><span className="font-medium">Delete</span> — request deletion of your account and associated data</li>
          </ul>
          <p className="mt-3">
        ...
        <section>
          ...
          <p>
            ...
            secure password hashing, and access controls. However, no method of transmission or
